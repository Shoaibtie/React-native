...
class Accordian extends Component {
  ...
  renderContent = (item) => {
    const { data, listType, props, commentData } = this.props;
    ...
    return (
      <View>
        {listType === 'commentSection' ?
          <CommentSection data={data} listType={listType} props={props} commentData={commentData} />
          : listType === constants.AVAILABILITY_SCREEN.SERVICE_TIMES ?
            ...
            listType === constants.AVAILABILITY_SCREEN.RESTRICTIONS ?
              ...
              <Attributes data={data} listType={listType} attClicked={attClicked} dropdownIndexAttribute={dropdownIndexAttribute}  /> :
